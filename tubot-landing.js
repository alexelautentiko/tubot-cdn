...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "hero.words": "takes orders|sends quotes|books visits|manages bookings|captures leads|collects documents|answers questions|reminds about appointments|chases payments|flags renewals|re-engages customers",
      ...
      "proc.c10p": "Warns before the insurance, appointment or maintenance is due. Zero renewals lost to forgetfulness.",
      "proc.c11h": "Customer & lead re-engagement",
      "proc.c11p": "Wakes up the contacts that went cold: customers who don't come back and leads who asked for a quote and never closed. With the right reason, at the right moment.",
      ...
      "io.inLabel": "From the customer to the business",
      "io.outLabel": "From the business to the customer",
      "a11y.tablistOut": "Outbound case",
      "io.outTab1": "Reminder",
      "io.outTab2": "Payment",
      "io.outTab3": "Renewal",
      "io.outTab4": "Re-engagement",
      ...
      "io.o4.sys": "Your system · CRM",
      "io.o4.k1": "Lead",
      "io.o4.k2": "Asked for", "io.o4.v2": "Renovation quote",
      "io.o4.k3": "Last contact", "io.o4.v3": "2 months ago",
      "io.o4.k4": "Status", "io.o4.v4": "Cold · not closed",
      "io.o4.msg": "Hi Carlos 👋 A while back we sent you a quote for your renovation. We've got a slot this month and a -10% deal. Shall we take another look and book a visit?<span class=\"time\">18:20<span class=\"tick\">✓✓</span></span>",
      "io.o4.dest": "Re-engaged — visit booked",
    ...
    ca: {
      ...
      "hero.words": "pren comandes|envia pressupostos|agenda visites|gestiona reserves|capta clients|recull documentació|respon dubtes|recorda cites|reclama cobraments|avisa de renovacions|reactiva clients",
      ...
      "proc.c10p": "Avisa abans que venci l'assegurança, la cita o el manteniment. Zero renovacions perdudes per descuit.",
      "proc.c11h": "Reactivació de clients i leads",
      "proc.c11p": "Desperta els contactes que s'han refredat: clients que no tornen i leads que van demanar pressupost i mai van tancar. Amb l'excusa adequada i en el moment just.",
      ...
      "io.o4.sys": "El teu sistema · CRM",
      "io.o4.k1": "Lead",
      "io.o4.k2": "Va demanar", "io.o4.v2": "Pressupost de reforma",
      "io.o4.k3": "Últim contacte", "io.o4.v3": "Fa 2 mesos",
      "io.o4.k4": "Estat", "io.o4.v4": "Refredat · sense tancar",
      "io.o4.msg": "Hola Carlos 👋 Fa un temps et vam passar pressupost per a la teva reforma. Aquest mes ens ha quedat un forat i una promo de -10%. Hi fem un cop d'ull i agendem visita?<span class=\"time\">18:20<span class=\"tick\">✓✓</span></span>",
      "io.o4.dest": "Reactivat — visita agendada",
      ...
      "seo.svcDesc": "Tubot crea bots de WhatsApp Business entrenats per a cada negoci, connectats als seus sistemes i operats de forma contínua. Atenen els missatges que entren i també s'avancen — recordatoris de cita, avisos de cobrament i de renovació, i reactivació de clients i leads — amb plantilles aprovades per Meta. El servei inclou desplegament, integracions, manteniment, suport i millora contínua.",
